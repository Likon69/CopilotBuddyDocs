...
| Public class | [BlackspotManager](../../../../classes/Styx/Logic/Pathing/FlightorNavigation/BlackspotManager.md) | Manages polygon-based aerial blackspots that Flightor avoids during flight. Ported from HB 6.2.3 BlackspotManager; WotLK-only default data. |
