# ActionSelectQuest Class

Selects a quest from the gossip or quest frame during questing.

## Inheritance Hierarchy
System.Object
  TreeSharp.Composite
    TreeSharp.Action
      Bots.Quest.Actions.ActionSelectQuest
...
The ActionSelectQuest type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionSelectQuest](ActionSelectQuest/Constructors/Constructor_64F51EADED21.md) | Initializes a new instance of the ActionSelectQuest class. |
| Public constructor | [ActionSelectQuest(int)](ActionSelectQuest/Constructors/Constructor_8572B39BC396.md) | Initializes a new instance of the ActionSelectQuest class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](ActionSelectQuest/Methods/Run_FA0BE3921CE8.md) | Runs the action. (Overrides Action.Run().) |
