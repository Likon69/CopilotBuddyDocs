# ActionSelectReward Class

Chooses a quest reward item during questing.
...
The ActionSelectReward type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionSelectReward](ActionSelectReward/Constructors/Constructor_E76CBA52998A.md) | Initializes a new instance of the ActionSelectReward class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](ActionSelectReward/Methods/Run_F2FD4FAD0F23.md) | Runs the action. (Overrides Action.Run().) |
