# DecoratorCanMoveToGrindArea Class

Represents a can move to grind area decorator.
...
System.Object
  TreeSharp.Composite
    TreeSharp.GroupComposite
      TreeSharp.Decorator
        Bots.Quest.Objectives.DecoratorCanMoveToGrindArea
...
The DecoratorCanMoveToGrindArea type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [DecoratorCanMoveToGrindArea(GrindArea, Composite)](DecoratorCanMoveToGrindArea/Constructors/Constructor_8504384D0C9C.md) | Initializes a new instance of the DecoratorCanMoveToGrindArea class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [CanRun(object)](DecoratorCanMoveToGrindArea/Methods/CanRun_DD701C1AF6C5.md) | Determines whether can run. (Overrides Decorator.CanRun().) |
