...
Represents a forced while step.

## Inheritance Hierarchy
System.Object
  Bots.Quest.QuestOrder.ForcedBehavior
    Bots.Quest.QuestOrder.ForcedWhile
...
The ForcedWhile type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ForcedWhile(WhileNode)](ForcedWhile/Constructors/Constructor_31EF52F89C7D.md) | Initializes a new instance of the ForcedWhile class. |

## Properties

| | Name | Description |
| --- | --- | --- |
| Public property | [IsDone](ForcedWhile/Properties/IsDone_4BEBCAC18F3C.md) | Gets a value indicating whether is done. (Overrides ForcedBehavior.IsDone.) |
| Public property | [WhileNode](ForcedWhile/Properties/WhileNode_8FDE177CE7B4.md) | Gets the while node. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [CreateBehavior](ForcedWhile/Methods/CreateBehavior_004CFB11B1F3.md) | Creates the behavior. (Overrides ForcedBehavior.CreateBehavior().) |
