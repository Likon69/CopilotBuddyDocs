# LootMode Enumeration

Represents values for Loot Mode.
...
## Syntax
```csharp
public sealed enum LootMode
```

The LootMode type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [LootMode](LootMode/Constructors/Constructor_65647BED8A1F.md) | Initializes a new instance of the LootMode enumeration. |

## Fields

| | Name | Description |
| --- | --- | --- |
| Public field | [Always](LootMode/Fields/Always_2DA5136958F0.md) | Loot tous les mobs |
| Public field | [BossesOnly](LootMode/Fields/BossesOnly_CB4A4D976FE9.md) | Loot uniquement les boss |
| Public field | [Never](LootMode/Fields/Never_1DF01607A77C.md) | Ne jamais loot |
