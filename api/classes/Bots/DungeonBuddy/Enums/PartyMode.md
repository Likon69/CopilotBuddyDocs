# PartyMode Enumeration

Represents values for Party Mode.
...
## Syntax
```csharp
public sealed enum PartyMode
```

The PartyMode type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [PartyMode](PartyMode/Constructors/Constructor_D835861471E2.md) | Initializes a new instance of the PartyMode enumeration. |

## Fields

| | Name | Description |
| --- | --- | --- |
| Public field | [Follower](PartyMode/Fields/Follower_3D10FBA389C1.md) | Represents the follower value. |
| Public field | [Leader](PartyMode/Fields/Leader_CBC655F45D9A.md) | Represents the leader value. |
| Public field | [Off](PartyMode/Fields/Off_AE410914A5A7.md) | Represents the off value. |
