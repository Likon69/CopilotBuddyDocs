...
Represents a logging action.

## Inheritance Hierarchy
System.Object
  TreeSharp.Composite
    TreeSharp.Action
      Bots.DungeonBuddy.Actions.ActionLogger

## Namespace
[Bots.DungeonBuddy.Actions](../../../../namespaces/Bots/DungeonBuddy/Actions.md)
...
## Syntax
```csharp
public class ActionLogger : Action
```

The ActionLogger type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionLogger(string, object[])](ActionLogger/Constructors/Constructor_62C3B82C79B0.md) | Initializes a new instance of the ActionLogger class. |
| Public constructor | [ActionLogger(Color, string, object[])](ActionLogger/Constructors/Constructor_6940C386622E.md) | Initializes a new instance of the ActionLogger class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](ActionLogger/Methods/Run_EACA655F7048.md) | Runs the action. (Overrides Action.Run().) |
...
## See Also
[Bots.DungeonBuddy.Actions Namespace](../../../../namespaces/Bots/DungeonBuddy/Actions.md)
