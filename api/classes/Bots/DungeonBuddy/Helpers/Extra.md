...
Represents a delegate for Extra.
...
| | Name | Description |
| --- | --- | --- |
| Public constructor | [Extra(object, nint)](Extra/Constructors/Constructor_26F03EF5FF05.md) | Initializes a new instance of the Extra delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(WoWUnit, AsyncCallback, object)](Extra/Methods/BeginInvoke_C8EFAEA6A05B.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](Extra/Methods/EndInvoke_18B24EFC7726.md) | Completes asynchronous invocation of the delegate. |
