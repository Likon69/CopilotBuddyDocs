# ScriptHelpers.EnemyDispellType Enumeration

Represents values for Enemy Dispell Type.
...
## Syntax
```csharp
public sealed enum ScriptHelpers.EnemyDispellType
```

The ScriptHelpers.EnemyDispellType type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [EnemyDispellType](EnemyDispellType/Constructors/Constructor_FDDE7F9713C7.md) | Initializes a new instance of the ScriptHelpers.EnemyDispellType enumeration. |

## Fields

| | Name | Description |
| --- | --- | --- |
| Public field | [Enrage](EnemyDispellType/Fields/Enrage_2BA91FE066DA.md) | Represents the enrage value. |
| Public field | [Magic](EnemyDispellType/Fields/Magic_FA3E48B42294.md) | Represents the magic value. |
