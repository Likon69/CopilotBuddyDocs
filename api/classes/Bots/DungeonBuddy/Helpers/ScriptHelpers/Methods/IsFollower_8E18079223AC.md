# ScriptHelpers.IsFollower Method

Determines whether is follower.
...
## Syntax
```csharp
public static bool IsFollower(LocalPlayer me)
```
...
| --- | --- | --- |
| me | [LocalPlayer](../../../../../Styx/WoWInternals/WoWObjects/LocalPlayer.md) | The me. |
