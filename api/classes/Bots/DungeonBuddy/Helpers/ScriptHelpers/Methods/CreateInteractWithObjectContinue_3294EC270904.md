# ScriptHelpers.CreateInteractWithObjectContinue Method

Creates the interact with object continue.
...
## Syntax
```csharp
public static Composite CreateInteractWithObjectContinue(CanRunDecoratorDelegate canRun, Func<WoWGameObject> obj, float range)
```
...
| obj | Func<WoWGameObject> | The obj. |
