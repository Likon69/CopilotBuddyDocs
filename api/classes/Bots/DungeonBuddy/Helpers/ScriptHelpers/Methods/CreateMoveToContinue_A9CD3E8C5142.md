...
## Syntax
```csharp
public static Composite CreateMoveToContinue(CanRunDecoratorDelegate canRun, Func<WoWObject> objectSelector, bool ignoreCombat)
```
...
| objectSelector | Func<WoWObject> | The object selector. |
