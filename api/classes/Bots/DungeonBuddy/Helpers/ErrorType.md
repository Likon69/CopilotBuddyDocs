...
Represents values for Error Type.
...
## Syntax
```csharp
public sealed enum ErrorType
```

The ErrorType type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ErrorType](ErrorType/Constructors/Constructor_1573B9FE36BF.md) | Initializes a new instance of the ErrorType enumeration. |

## Fields

| | Name | Description |
| --- | --- | --- |
| Public field | [Error](ErrorType/Fields/Error_EB73E0FB3E71.md) | Represents the error error. |
| Public field | [Warning](ErrorType/Fields/Warning_6529FF0AF501.md) | Represents the warning error. |
