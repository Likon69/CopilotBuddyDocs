...
## Syntax
```csharp
public AvoidInfo(CanRunDecoratorDelegate condition, Predicate<WoWObject> objectSelector, Func<float> radiusSelector, Func<WoWPoint> leashPointSelector, float leashRadius, bool isBlocking)
```
