# AvoidSide Enumeration

Represents values for Avoid Side.
...
## Syntax
```csharp
public sealed enum AvoidSide
```

The AvoidSide type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [AvoidSide](AvoidSide/Constructors/Constructor_02329D0A1949.md) | Initializes a new instance of the AvoidSide enumeration. |

## Fields

| | Name | Description |
| --- | --- | --- |
| Public field | [Left](AvoidSide/Fields/Left_B6B093A42479.md) | Represents the left value. |
| Public field | [Right](AvoidSide/Fields/Right_07C12AE9C146.md) | Represents the right value. |
