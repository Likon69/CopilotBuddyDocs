# ActionMoveToCorpse Class

Represents a move to corpse action.
  ...
  TreeSharp.Composite
    TreeSharp.Action
      CommonBehaviors.Actions.NavigationAction
        Levelbot.Actions.Death.ActionMoveToCorpse
...
The ActionMoveToCorpse type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionMoveToCorpse](ActionMoveToCorpse/Constructors/Constructor_83B58434DFAA.md) | Initializes a new instance of the ActionMoveToCorpse class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](ActionMoveToCorpse/Methods/Run_617524B4E4A8.md) | Runs the action. (Overrides NavigationAction.Run().) |
