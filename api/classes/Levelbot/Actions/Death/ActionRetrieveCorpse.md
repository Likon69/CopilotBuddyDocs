# ActionRetrieveCorpse Class

Represents a retrieve corpse action.

## Inheritance Hierarchy
System.Object
  TreeSharp.Composite
    TreeSharp.Action
      Levelbot.Actions.Death.ActionRetrieveCorpse
...
## Syntax
```csharp
public class ActionRetrieveCorpse : Action
```

The ActionRetrieveCorpse type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionRetrieveCorpse](ActionRetrieveCorpse/Constructors/Constructor_309B848126A5.md) | Initializes a new instance of the ActionRetrieveCorpse class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](ActionRetrieveCorpse/Methods/Run_385A489F544E.md) | Runs the action. (Overrides Action.Run().) |
