...
Represents a suceed if dead or ghost action.

## Inheritance Hierarchy
System.Object
  TreeSharp.Composite
    TreeSharp.Action
      Levelbot.Actions.Death.ActionSuceedIfDeadOrGhost
...
The ActionSuceedIfDeadOrGhost type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionSuceedIfDeadOrGhost](ActionSuceedIfDeadOrGhost/Constructors/Constructor_DA5DE7A7275F.md) | Initializes a new instance of the ActionSuceedIfDeadOrGhost class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](ActionSuceedIfDeadOrGhost/Methods/Run_539E5966BEF6.md) | Runs the action. (Overrides Action.Run().) |
