...
Represents a pull action.

## Inheritance Hierarchy
System.Object
  TreeSharp.Composite
    TreeSharp.Action
      Levelbot.Actions.Combat.ActionPull
...
The ActionPull type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionPull](ActionPull/Constructors/Constructor_831174B0775F.md) | Initializes a new instance of the ActionPull class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](ActionPull/Methods/Run_43BC91E18121.md) | Runs the action. (Overrides Action.Run().) |
