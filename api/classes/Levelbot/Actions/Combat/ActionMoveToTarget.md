...
Represents a move to target action.
  ...
  TreeSharp.Composite
    TreeSharp.Action
      CommonBehaviors.Actions.NavigationAction
        Levelbot.Actions.Combat.ActionMoveToTarget
...
The ActionMoveToTarget type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionMoveToTarget](ActionMoveToTarget/Constructors/Constructor_DE4AD013349B.md) | Initializes a new instance of the ActionMoveToTarget class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](ActionMoveToTarget/Methods/Run_EE806908CA9D.md) | Runs the action. (Overrides NavigationAction.Run().) |
