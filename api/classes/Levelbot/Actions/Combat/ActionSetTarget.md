...
Represents a set target action.

## Inheritance Hierarchy
System.Object
  TreeSharp.Composite
    TreeSharp.Action
      Levelbot.Actions.Combat.ActionSetTarget
...
The ActionSetTarget type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionSetTarget](ActionSetTarget/Constructors/Constructor_03505DDF388D.md) | Initializes a new instance of the ActionSetTarget class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](ActionSetTarget/Methods/Run_AF9C52721485.md) | Runs the action. (Overrides Action.Run().) |
