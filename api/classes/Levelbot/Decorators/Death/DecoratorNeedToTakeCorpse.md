...
Represents a need to take corpse decorator.
...
System.Object
  TreeSharp.Composite
    TreeSharp.GroupComposite
      TreeSharp.Decorator
        Levelbot.Decorators.Death.DecoratorNeedToTakeCorpse
...
The DecoratorNeedToTakeCorpse type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [DecoratorNeedToTakeCorpse(Composite)](DecoratorNeedToTakeCorpse/Constructors/Constructor_AA0D8F293B09.md) | Initializes a new instance of the DecoratorNeedToTakeCorpse class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [CanRun(object)](DecoratorNeedToTakeCorpse/Methods/CanRun_E37D15480491.md) | Determines whether can run. (Overrides Decorator.CanRun().) |
