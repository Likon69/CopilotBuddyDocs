...
Represents a need to release decorator.
...
The DecoratorNeedToRelease type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [DecoratorNeedToRelease(Composite)](DecoratorNeedToRelease/Constructors/Constructor_C0940AB9BDD3.md) | Initializes a new instance of the DecoratorNeedToRelease class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [CanRun(object)](DecoratorNeedToRelease/Methods/CanRun_FADF0F6F9AC5.md) | Determines whether can run. (Overrides Decorator.CanRun().) |
