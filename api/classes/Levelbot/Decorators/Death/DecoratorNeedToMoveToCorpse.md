...
Represents a need to move to corpse decorator.
...
System.Object
  TreeSharp.Composite
    TreeSharp.GroupComposite
      TreeSharp.Decorator
        Levelbot.Decorators.Death.DecoratorNeedToMoveToCorpse
...
The DecoratorNeedToMoveToCorpse type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [DecoratorNeedToMoveToCorpse(Composite)](DecoratorNeedToMoveToCorpse/Constructors/Constructor_DD28304A383F.md) | Initializes a new instance of the DecoratorNeedToMoveToCorpse class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [CanRun(object)](DecoratorNeedToMoveToCorpse/Methods/CanRun_FA2CD54ADF75.md) | Determines whether can run. (Overrides Decorator.CanRun().) |
