...
Represents an instance release decorator.
...
System.Object
  TreeSharp.Composite
    TreeSharp.GroupComposite
      TreeSharp.Decorator
        Levelbot.Decorators.Death.DecoratorNeedToRelease
          Levelbot.Decorators.Death.DecoratorInstanceRelease
...
The DecoratorInstanceRelease type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [DecoratorInstanceRelease(Composite)](DecoratorInstanceRelease/Constructors/Constructor_8A9B4442BC94.md) | Initializes a new instance of the DecoratorInstanceRelease class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [CanRun(object)](DecoratorInstanceRelease/Methods/CanRun_CE057A03464E.md) | Determines whether can run. (Overrides DecoratorNeedToRelease.CanRun().) |
