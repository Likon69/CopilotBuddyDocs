# DecoratorNeedToFindTarget Class

Represents a need to find target decorator.
...
System.Object
  TreeSharp.Composite
    TreeSharp.GroupComposite
      TreeSharp.Decorator
        Levelbot.Decorators.Combat.DecoratorNeedToFindTarget
...
The DecoratorNeedToFindTarget type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [DecoratorNeedToFindTarget(Composite)](DecoratorNeedToFindTarget/Constructors/Constructor_692E35A33AD4.md) | Initializes a new instance of the DecoratorNeedToFindTarget class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [CanRun(object)](DecoratorNeedToFindTarget/Methods/CanRun_0272A9B5699D.md) | Determines whether can run. (Overrides Decorator.CanRun().) |
