...
Represents a delegate for weigh targets.
...
## Syntax
```csharp
public sealed delegate WeighTargetsDelegate
```

The WeighTargetsDelegate type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [WeighTargetsDelegate(object, nint)](WeighTargetsDelegate/Constructors/Constructor_AB0F564CD49E.md) | Initializes a new instance of the WeighTargetsDelegate delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(List<TargetPriority>, AsyncCallback, object)](WeighTargetsDelegate/Methods/BeginInvoke_A0E228C14A5E.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](WeighTargetsDelegate/Methods/EndInvoke_6B68D0642540.md) | Completes asynchronous invocation of the delegate. |
