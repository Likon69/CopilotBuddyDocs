...
Represents a delegate for include targets filter.
...
## Syntax
```csharp
public sealed delegate IncludeTargetsFilterDelegate
```

The IncludeTargetsFilterDelegate type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [IncludeTargetsFilterDelegate(object, nint)](IncludeTargetsFilterDelegate/Constructors/Constructor_2C042E60D4D5.md) | Initializes a new instance of the IncludeTargetsFilterDelegate delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(List<WoWObject>, HashSet<WoWObject>, AsyncCallback, object)](IncludeTargetsFilterDelegate/Methods/BeginInvoke_01D0EC13D679.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](IncludeTargetsFilterDelegate/Methods/EndInvoke_F794BA445560.md) | Completes asynchronous invocation of the delegate. |
