...
Represents a delegate for remove targets filter.
...
## Syntax
```csharp
public sealed delegate RemoveTargetsFilterDelegate
```

The RemoveTargetsFilterDelegate type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [RemoveTargetsFilterDelegate(object, nint)](RemoveTargetsFilterDelegate/Constructors/Constructor_B0E460159B53.md) | Initializes a new instance of the RemoveTargetsFilterDelegate delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(List<WoWObject>, AsyncCallback, object)](RemoveTargetsFilterDelegate/Methods/BeginInvoke_6D72005AA145.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](RemoveTargetsFilterDelegate/Methods/EndInvoke_DF71A2C51E93.md) | Completes asynchronous invocation of the delegate. |
