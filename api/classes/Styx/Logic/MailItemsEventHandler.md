...
Event handler delegate for mail items
...
## Syntax
```csharp
public sealed delegate MailItemsEventHandler
```

The MailItemsEventHandler type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [MailItemsEventHandler(object, nint)](MailItemsEventHandler/Constructors/Constructor_E0B314390B99.md) | Initializes a new instance of the MailItemsEventHandler delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(MailItemsEventArgs, AsyncCallback, object)](MailItemsEventHandler/Methods/BeginInvoke_FCB4C91EBD00.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](MailItemsEventHandler/Methods/EndInvoke_034A9FF37D15.md) | Completes asynchronous invocation of the delegate. |
