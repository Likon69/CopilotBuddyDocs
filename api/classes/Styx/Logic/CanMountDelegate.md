# CanMountDelegate Delegate

Delegate for checking if mount is allowed
...
## Syntax
```csharp
public sealed delegate CanMountDelegate
```

The CanMountDelegate type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [CanMountDelegate(object, nint)](CanMountDelegate/Constructors/Constructor_D46507EEB6BB.md) | Initializes a new instance of the CanMountDelegate delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(AsyncCallback, object)](CanMountDelegate/Methods/BeginInvoke_9D45FA1F0247.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](CanMountDelegate/Methods/EndInvoke_0C3F46D32382.md) | Completes asynchronous invocation of the delegate. |
