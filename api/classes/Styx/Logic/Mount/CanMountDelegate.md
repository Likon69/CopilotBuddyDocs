# Mount.CanMountDelegate Delegate

Represents a delegate for can mount.
...
## Syntax
```csharp
public sealed delegate Mount.CanMountDelegate
```

The Mount.CanMountDelegate type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [CanMountDelegate(object, nint)](CanMountDelegate/Constructors/Constructor_50BA32443DFD.md) | Initializes a new instance of the Mount.CanMountDelegate delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(AsyncCallback, object)](CanMountDelegate/Methods/BeginInvoke_998F877D420F.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](CanMountDelegate/Methods/EndInvoke_0733EF973B11.md) | Completes asynchronous invocation of the delegate. |
