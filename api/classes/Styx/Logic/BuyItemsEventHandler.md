...
## Syntax
```csharp
public sealed delegate BuyItemsEventHandler
```

The BuyItemsEventHandler type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [BuyItemsEventHandler(object, nint)](BuyItemsEventHandler/Constructors/Constructor_FD79DA9D4A5F.md) | Initializes a new instance of the BuyItemsEventHandler delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(BuyItemsEventArgs, AsyncCallback, object)](BuyItemsEventHandler/Methods/BeginInvoke_B22580DEDB4A.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](BuyItemsEventHandler/Methods/EndInvoke_86A182A291C9.md) | Completes asynchronous invocation of the delegate. |
