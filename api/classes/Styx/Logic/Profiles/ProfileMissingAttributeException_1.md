...
System.Object
  System.Exception
    Styx.Logic.Profiles.ProfileException
      Styx.Logic.Profiles.ProfileMissingAttributeException<T>
...
The ProfileMissingAttributeException<T> type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ProfileMissingAttributeException(string, XElement)](ProfileMissingAttributeException_1/Constructors/Constructor_0F4BBEA26326.md) | Initializes a new instance of the ProfileMissingAttributeException<T> class. |
