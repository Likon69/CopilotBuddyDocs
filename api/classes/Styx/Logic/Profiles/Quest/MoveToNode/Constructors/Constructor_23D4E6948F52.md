# MoveToNode.MoveToNode Constructor
...
## Syntax
```csharp
public MoveToNode(WoWPoint location, string locationName, float precision, uint questId, NavType? navType)
```
...
| navType | NavType? | The nav type. |

## See Also
[MoveToNode Class](../../MoveToNode.md)
