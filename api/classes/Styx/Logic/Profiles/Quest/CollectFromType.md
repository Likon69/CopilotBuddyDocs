...
Type of source for collecting items.
...
## Syntax
```csharp
public sealed enum CollectFromType
```

The CollectFromType type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [CollectFromType](CollectFromType/Constructors/Constructor_0FEDEB5AC329.md) | Initializes a new instance of the CollectFromType enumeration. |

## Fields

| | Name | Description |
| --- | --- | --- |
| Public field | [GameObject](CollectFromType/Fields/GameObject_080AEF7B0F7A.md) | Represents the game object value. |
| Public field | [Mob](CollectFromType/Fields/Mob_EB3A759A6B25.md) | Represents the mob value. |
| Public field | [None](CollectFromType/Fields/None_3D9239A0DD61.md) | Represents the none value. |
| Public field | [Vendor](CollectFromType/Fields/Vendor_529B8A421779.md) | Represents the vendor value. |
