...
System.Object
  System.Exception
    Styx.Logic.Profiles.ProfileException
      Styx.Logic.Profiles.ProfileAttributeExpectedException<T>
...
The ProfileAttributeExpectedException<T> type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ProfileAttributeExpectedException(XAttribute, string[])](ProfileAttributeExpectedException_1/Constructors/Constructor_231AD237D2AE.md) | Initializes a new instance of the ProfileAttributeExpectedException<T> class. |
