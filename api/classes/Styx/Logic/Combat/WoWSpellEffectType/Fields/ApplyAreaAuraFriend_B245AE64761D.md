# WoWSpellEffectType.ApplyAreaAuraFriend Field

Represents the apply area aura friend value.
...
## Syntax
```csharp
public const WoWSpellEffectType ApplyAreaAuraFriend
```

## Field Value

Type: [WoWSpellEffectType](../../WoWSpellEffectType.md)
The apply area aura friend value.
