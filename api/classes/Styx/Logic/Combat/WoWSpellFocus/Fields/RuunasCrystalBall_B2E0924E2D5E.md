# WoWSpellFocus.RuunasCrystalBall Field

Represents the ruunas crystal ball value.
...
## Syntax
```csharp
public const WoWSpellFocus RuunasCrystalBall
```

## Field Value

Type: [WoWSpellFocus](../../WoWSpellFocus.md)
The ruunas crystal ball value.
