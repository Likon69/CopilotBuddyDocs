# WoWSpellFocus.SoakedFertileDirt Field

Represents the soaked fertile dirt value.
...
## Syntax
```csharp
public const WoWSpellFocus SoakedFertileDirt
```

## Field Value

Type: [WoWSpellFocus](../../WoWSpellFocus.md)
The soaked fertile dirt value.
