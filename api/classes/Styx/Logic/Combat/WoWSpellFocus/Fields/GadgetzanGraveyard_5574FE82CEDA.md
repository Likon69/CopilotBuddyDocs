# WoWSpellFocus.GadgetzanGraveyard Field

Represents the gadgetzan graveyard value.
...
## Syntax
```csharp
public const WoWSpellFocus GadgetzanGraveyard
```

## Field Value

Type: [WoWSpellFocus](../../WoWSpellFocus.md)
The gadgetzan graveyard value.
