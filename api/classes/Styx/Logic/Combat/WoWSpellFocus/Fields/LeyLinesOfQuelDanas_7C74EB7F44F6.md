# WoWSpellFocus.LeyLinesOfQuelDanas Field

Represents the ley lines of quel danas value.
...
## Syntax
```csharp
public const WoWSpellFocus LeyLinesOfQuelDanas
```

## Field Value

Type: [WoWSpellFocus](../../WoWSpellFocus.md)
The ley lines of quel danas value.
