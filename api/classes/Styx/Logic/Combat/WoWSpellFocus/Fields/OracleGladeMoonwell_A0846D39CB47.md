# WoWSpellFocus.OracleGladeMoonwell Field

Represents the oracle glade moonwell value.
...
## Syntax
```csharp
public const WoWSpellFocus OracleGladeMoonwell
```

## Field Value

Type: [WoWSpellFocus](../../WoWSpellFocus.md)
The oracle glade moonwell value.
