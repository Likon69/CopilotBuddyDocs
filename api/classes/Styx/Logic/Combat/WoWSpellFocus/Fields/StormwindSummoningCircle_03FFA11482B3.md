# WoWSpellFocus.StormwindSummoningCircle Field

Represents the stormwind summoning circle value.
...
## Syntax
```csharp
public const WoWSpellFocus StormwindSummoningCircle
```

## Field Value

Type: [WoWSpellFocus](../../WoWSpellFocus.md)
The stormwind summoning circle value.
