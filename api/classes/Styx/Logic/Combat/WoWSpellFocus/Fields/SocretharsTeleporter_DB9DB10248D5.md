# WoWSpellFocus.SocretharsTeleporter Field

Represents the socrethars teleporter value.
...
## Syntax
```csharp
public const WoWSpellFocus SocretharsTeleporter
```

## Field Value

Type: [WoWSpellFocus](../../WoWSpellFocus.md)
The socrethars teleporter value.
