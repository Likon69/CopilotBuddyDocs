# WoWApplyAuraType.ModAttackPowerOfArmor Field

Represents the mod attack power of armor value.
...
## Syntax
```csharp
public const WoWApplyAuraType ModAttackPowerOfArmor
```

## Field Value

Type: [WoWApplyAuraType](../../WoWApplyAuraType.md)
The mod attack power of armor value.
