# WoWApplyAuraType.ModAttackerSpellHitChance Field

Represents the mod attacker spell hit chance value.
...
## Syntax
```csharp
public const WoWApplyAuraType ModAttackerSpellHitChance
```

## Field Value

Type: [WoWApplyAuraType](../../WoWApplyAuraType.md)
The mod attacker spell hit chance value.
