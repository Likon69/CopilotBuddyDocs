# WoWApplyAuraType.PeriodicManaFunnel Field

Represents the periodic mana funnel value.
...
## Syntax
```csharp
public const WoWApplyAuraType PeriodicManaFunnel
```

## Field Value

Type: [WoWApplyAuraType](../../WoWApplyAuraType.md)
The periodic mana funnel value.
