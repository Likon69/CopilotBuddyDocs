# WoWApplyAuraType.ModResistanceExclusive Field

Represents the mod resistance exclusive value.
...
## Syntax
```csharp
public const WoWApplyAuraType ModResistanceExclusive
```

## Field Value

Type: [WoWApplyAuraType](../../WoWApplyAuraType.md)
The mod resistance exclusive value.
