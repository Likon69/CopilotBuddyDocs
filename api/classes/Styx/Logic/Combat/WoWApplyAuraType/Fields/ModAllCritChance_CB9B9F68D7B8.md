# WoWApplyAuraType.ModAllCritChance Field

Represents the mod all crit chance value.
...
## Syntax
```csharp
public const WoWApplyAuraType ModAllCritChance
```

## Field Value

Type: [WoWApplyAuraType](../../WoWApplyAuraType.md)
The mod all crit chance value.
