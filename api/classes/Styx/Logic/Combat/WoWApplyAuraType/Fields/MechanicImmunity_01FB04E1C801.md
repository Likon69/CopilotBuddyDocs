# WoWApplyAuraType.MechanicImmunity Field

Represents the mechanic immunity value.
...
## Syntax
```csharp
public const WoWApplyAuraType MechanicImmunity
```

## Field Value

Type: [WoWApplyAuraType](../../WoWApplyAuraType.md)
The mechanic immunity value.
