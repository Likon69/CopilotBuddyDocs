# WoWApplyAuraType.ModSpeedNotStack Field

Represents the mod speed not stack value.
...
## Syntax
```csharp
public const WoWApplyAuraType ModSpeedNotStack
```

## Field Value

Type: [WoWApplyAuraType](../../WoWApplyAuraType.md)
The mod speed not stack value.
