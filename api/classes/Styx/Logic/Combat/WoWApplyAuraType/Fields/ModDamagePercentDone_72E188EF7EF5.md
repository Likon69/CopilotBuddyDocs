# WoWApplyAuraType.ModDamagePercentDone Field

Represents the mod damage percent done value.
...
## Syntax
```csharp
public const WoWApplyAuraType ModDamagePercentDone
```

## Field Value

Type: [WoWApplyAuraType](../../WoWApplyAuraType.md)
The mod damage percent done value.
