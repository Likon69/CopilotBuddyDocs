...
Delegate that is called when the target list update finishes.
...
## Syntax
```csharp
public sealed delegate TargetListUpdateFinishedDelegate
```

The TargetListUpdateFinishedDelegate type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [TargetListUpdateFinishedDelegate(object, nint)](TargetListUpdateFinishedDelegate/Constructors/Constructor_58FE9D92DEC0.md) | Initializes a new instance of the TargetListUpdateFinishedDelegate delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(object, AsyncCallback, object)](TargetListUpdateFinishedDelegate/Methods/BeginInvoke_213083F472D8.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](TargetListUpdateFinishedDelegate/Methods/EndInvoke_C9786F374611.md) | Completes asynchronous invocation of the delegate. |
