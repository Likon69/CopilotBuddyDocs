# CustomForcedBehavior.GetAttributeAsDouble Method
...
## Syntax
```csharp
public double? GetAttributeAsDouble(string attributeName, bool isAttributeRequired, double minValue, double maxValue, string[] attributeNameAliases)
```
