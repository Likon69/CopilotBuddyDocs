# CustomForcedBehavior.GetAttributeAsRange Method

Gets the attribute as range.
...
## Syntax
```csharp
public int? GetAttributeAsRange(string attributeName, bool isAttributeRequired, string[] attributeNameAliases)
```
