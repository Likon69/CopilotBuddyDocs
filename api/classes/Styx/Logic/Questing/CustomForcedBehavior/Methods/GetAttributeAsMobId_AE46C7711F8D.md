# CustomForcedBehavior.GetAttributeAsMobId Method

Gets the attribute as mob id.
...
## Syntax
```csharp
public int? GetAttributeAsMobId(string attributeName, bool isAttributeRequired, string[] attributeNameAliases)
```
