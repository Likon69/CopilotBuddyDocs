# CustomForcedBehavior.GetAttributeAsString Method
...
## Syntax
```csharp
public string GetAttributeAsString(string attributeName, bool isAttributeRequired, string[] attributeNameAliases)
```
