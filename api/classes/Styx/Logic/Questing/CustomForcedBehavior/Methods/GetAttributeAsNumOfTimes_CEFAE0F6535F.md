# CustomForcedBehavior.GetAttributeAsNumOfTimes Method

Gets the attribute as num of times.
...
## Syntax
```csharp
public int? GetAttributeAsNumOfTimes(string attributeName, bool isAttributeRequired, string[] attributeNameAliases)
```
