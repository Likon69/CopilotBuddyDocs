# CustomForcedBehavior.GetAttributeAsWaitTime Method

Gets the attribute as wait time.
...
## Syntax
```csharp
public int? GetAttributeAsWaitTime(string attributeName, bool isAttributeRequired, string[] attributeNameAliases)
```
