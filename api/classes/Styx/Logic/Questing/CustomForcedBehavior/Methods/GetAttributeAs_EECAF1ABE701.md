# CustomForcedBehavior.GetAttributeAs Method

Gets the attribute as.
...
## Syntax
```csharp
public T GetAttributeAs(string attributeName, bool isAttributeRequired, IConstraintChecker<T> constraints, string[] attributeNameAliases)
```
...
| constraints | [IConstraintChecker<T>](../IConstraintChecker_1.md) | The constraints. |
