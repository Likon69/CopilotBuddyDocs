# CustomForcedBehavior.GetAttributeAsItemId Method

Gets the attribute as item id.
...
## Syntax
```csharp
public int? GetAttributeAsItemId(string attributeName, bool isAttributeRequired, string[] attributeNameAliases)
```
