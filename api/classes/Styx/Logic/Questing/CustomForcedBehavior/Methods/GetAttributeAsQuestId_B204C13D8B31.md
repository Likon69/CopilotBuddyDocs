# CustomForcedBehavior.GetAttributeAsQuestId Method

Gets the attribute as quest id.
...
## Syntax
```csharp
public int? GetAttributeAsQuestId(string attributeName, bool isAttributeRequired, string[] attributeNameAliases)
```
