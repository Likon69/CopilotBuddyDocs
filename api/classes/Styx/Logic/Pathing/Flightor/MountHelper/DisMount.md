...
System.Object
  TreeSharp.Composite
    TreeSharp.Action
      Styx.Logic.Pathing.Flightor.MountHelper.DisMount
...
## Syntax
```csharp
public class Flightor.MountHelper.DisMount : Action
```

The Flightor.MountHelper.DisMount type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [DisMount](DisMount/Constructors/Constructor_8134D6EAC092.md) | Initializes a new instance of the Flightor.MountHelper.DisMount class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](DisMount/Methods/Run_995464F4DD88.md) | Runs the action. (Overrides Action.Run().) |
