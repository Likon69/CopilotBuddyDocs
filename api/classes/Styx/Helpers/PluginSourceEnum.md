...
## Syntax
```csharp
public sealed enum PluginSourceEnum
```

The PluginSourceEnum type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [PluginSourceEnum](PluginSourceEnum/Constructors/Constructor_ED21141CBB71.md) | Initializes a new instance of the PluginSourceEnum enumeration. |

## Fields

| | Name | Description |
| --- | --- | --- |
| Public field | [Both](PluginSourceEnum/Fields/Both_75552AD0C54A.md) | Load from both sources. |
| Public field | [DynamicAssemblies](PluginSourceEnum/Fields/DynamicAssemblies_CDEDCB321959.md) | Load from pre-compiled assemblies. |
| Public field | [DynamicCompilation](PluginSourceEnum/Fields/DynamicCompilation_E9C6D7691D35.md) | Compile from source files. |
