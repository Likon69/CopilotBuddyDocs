...
## Syntax
```csharp
public static void RemoveAll(Dictionary<TKey, TValue> dictionary, Func<TKey, TValue, bool> predicate)
```
...
| predicate | Func<TKey, TValue, bool> | The condition to match key-value pairs for removal. |
