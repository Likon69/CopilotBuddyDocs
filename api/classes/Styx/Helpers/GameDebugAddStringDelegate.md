...
Represents a delegate for game debug add string.
...
## Syntax
```csharp
public sealed delegate GameDebugAddStringDelegate
```

The GameDebugAddStringDelegate type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [GameDebugAddStringDelegate(object, nint)](GameDebugAddStringDelegate/Constructors/Constructor_61E05C08CAEE.md) | Initializes a new instance of the GameDebugAddStringDelegate delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(StringBuilder, AsyncCallback, object)](GameDebugAddStringDelegate/Methods/BeginInvoke_FC228DFF1485.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](GameDebugAddStringDelegate/Methods/EndInvoke_0AD247C13141.md) | Completes asynchronous invocation of the delegate. |
