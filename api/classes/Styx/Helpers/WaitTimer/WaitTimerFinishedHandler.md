# WaitTimer.WaitTimerFinishedHandler Delegate

Represents a delegate for Wait Timer Finished Handler.
...
## Syntax
```csharp
public sealed delegate WaitTimer.WaitTimerFinishedHandler
```

The WaitTimer.WaitTimerFinishedHandler type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [WaitTimerFinishedHandler(object, nint)](WaitTimerFinishedHandler/Constructors/Constructor_F83806D9944C.md) | Initializes a new instance of the WaitTimer.WaitTimerFinishedHandler delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(object, WaitTimerEventArgs, AsyncCallback, object)](WaitTimerFinishedHandler/Methods/BeginInvoke_C35E8EFE5909.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](WaitTimerFinishedHandler/Methods/EndInvoke_5881141F820C.md) | Completes asynchronous invocation of the delegate. |
