# InfoPanelUpdatedDelegate Delegate

Represents a delegate for info panel updated.
...
## Syntax
```csharp
public sealed delegate InfoPanelUpdatedDelegate
```

The InfoPanelUpdatedDelegate type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [InfoPanelUpdatedDelegate(object, nint)](InfoPanelUpdatedDelegate/Constructors/Constructor_877D5C4206CA.md) | Initializes a new instance of the InfoPanelUpdatedDelegate delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(AsyncCallback, object)](InfoPanelUpdatedDelegate/Methods/BeginInvoke_4B72F7D01960.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](InfoPanelUpdatedDelegate/Methods/EndInvoke_76DD21BC7538.md) | Completes asynchronous invocation of the delegate. |
