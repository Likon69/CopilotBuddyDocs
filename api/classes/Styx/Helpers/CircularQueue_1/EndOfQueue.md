# CircularQueue.EndOfQueue Delegate

Represents a delegate for End Of Queue.
...
## Syntax
```csharp
public sealed delegate CircularQueue.EndOfQueue
```

The CircularQueue.EndOfQueue type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [EndOfQueue(object, nint)](EndOfQueue/Constructors/Constructor_FD4AD3A2D7EE.md) | Initializes a new instance of the CircularQueue.EndOfQueue delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(object, EventArgs, AsyncCallback, object)](EndOfQueue/Methods/BeginInvoke_4C341A5C56E9.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](EndOfQueue/Methods/EndInvoke_2F9E7DDCE6E8.md) | Completes asynchronous invocation of the delegate. |
