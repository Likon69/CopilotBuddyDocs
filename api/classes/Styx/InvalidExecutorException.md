...
Represents an invalid executor exception.

## Inheritance Hierarchy
System.Object
  System.Exception
    Styx.InvalidExecutorException
...
The InvalidExecutorException type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [InvalidExecutorException](InvalidExecutorException/Constructors/Constructor_17F5945C7B3B.md) | Initializes a new instance of the InvalidExecutorException class. |
| Public constructor | [InvalidExecutorException(string)](InvalidExecutorException/Constructors/Constructor_07FAA8A67E04.md) | Initializes a new instance of the InvalidExecutorException class. |
| Public constructor | [InvalidExecutorException(string, Exception)](InvalidExecutorException/Constructors/Constructor_00618A67C1DC.md) | Initializes a new instance of the InvalidExecutorException class. |
| Protected constructor | [InvalidExecutorException(SerializationInfo, StreamingContext)](InvalidExecutorException/Constructors/Constructor_43D7D2B8AE25.md) | Initializes a new instance of the InvalidExecutorException class. |
