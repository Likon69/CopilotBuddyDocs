...
Represents a delegate for battleground left.
...
## Syntax
```csharp
public sealed delegate BotEvents.Battleground.BattlegroundLeftDelegate
```

The BotEvents.Battleground.BattlegroundLeftDelegate type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [BattlegroundLeftDelegate(object, nint)](BattlegroundLeftDelegate/Constructors/Constructor_F1B1F309607C.md) | Initializes a new instance of the BotEvents.Battleground.BattlegroundLeftDelegate delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(EventArgs, AsyncCallback, object)](BattlegroundLeftDelegate/Methods/BeginInvoke_8712ED0F6011.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](BattlegroundLeftDelegate/Methods/EndInvoke_24ED397124EB.md) | Completes asynchronous invocation of the delegate. |
