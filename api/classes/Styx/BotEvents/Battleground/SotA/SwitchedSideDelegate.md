# BotEvents.Battleground.SotA.SwitchedSideDelegate Delegate

Represents a delegate for switched side.
...
## Syntax
```csharp
public sealed delegate BotEvents.Battleground.SotA.SwitchedSideDelegate
```

The BotEvents.Battleground.SotA.SwitchedSideDelegate type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [SwitchedSideDelegate(object, nint)](SwitchedSideDelegate/Constructors/Constructor_87F512D5CF19.md) | Initializes a new instance of the BotEvents.Battleground.SotA.SwitchedSideDelegate delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(SotAObjective, AsyncCallback, object)](SwitchedSideDelegate/Methods/BeginInvoke_88CD751C6231.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](SwitchedSideDelegate/Methods/EndInvoke_8D7F64C8C583.md) | Completes asynchronous invocation of the delegate. |
