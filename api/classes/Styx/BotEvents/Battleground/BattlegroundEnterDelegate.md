...
Represents a delegate for battleground enter.
...
## Syntax
```csharp
public sealed delegate BotEvents.Battleground.BattlegroundEnterDelegate
```

The BotEvents.Battleground.BattlegroundEnterDelegate type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [BattlegroundEnterDelegate(object, nint)](BattlegroundEnterDelegate/Constructors/Constructor_D9C530BE1431.md) | Initializes a new instance of the BotEvents.Battleground.BattlegroundEnterDelegate delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(BattlegroundType, AsyncCallback, object)](BattlegroundEnterDelegate/Methods/BeginInvoke_6D9C2E45098C.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](BattlegroundEnterDelegate/Methods/EndInvoke_3124DB1A046A.md) | Completes asynchronous invocation of the delegate. |
