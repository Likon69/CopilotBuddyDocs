...
Represents a delegate for on bot changed.
...
## Syntax
```csharp
public sealed delegate BotEvents.OnBotChangedDelegate
```

The BotEvents.OnBotChangedDelegate type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [OnBotChangedDelegate(object, nint)](OnBotChangedDelegate/Constructors/Constructor_8AEE21F7D429.md) | Initializes a new instance of the BotEvents.OnBotChangedDelegate delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(BotChangedEventArgs, AsyncCallback, object)](OnBotChangedDelegate/Methods/BeginInvoke_5F6281E26AA8.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](OnBotChangedDelegate/Methods/EndInvoke_06E4D3191503.md) | Completes asynchronous invocation of the delegate. |
