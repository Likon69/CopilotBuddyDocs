...
Represents a delegate for quest accepted.
...
## Syntax
```csharp
public sealed delegate BotEvents.Questing.QuestAcceptedDelegate
```

The BotEvents.Questing.QuestAcceptedDelegate type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [QuestAcceptedDelegate(object, nint)](QuestAcceptedDelegate/Constructors/Constructor_9A9C1DDC43A9.md) | Initializes a new instance of the BotEvents.Questing.QuestAcceptedDelegate delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(Quest, AsyncCallback, object)](QuestAcceptedDelegate/Methods/BeginInvoke_2D8302BE9974.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](QuestAcceptedDelegate/Methods/EndInvoke_C2078B853BFE.md) | Completes asynchronous invocation of the delegate. |
