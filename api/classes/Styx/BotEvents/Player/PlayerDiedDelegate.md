...
Represents a delegate for player died.
...
## Syntax
```csharp
public sealed delegate BotEvents.Player.PlayerDiedDelegate
```

The BotEvents.Player.PlayerDiedDelegate type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [PlayerDiedDelegate(object, nint)](PlayerDiedDelegate/Constructors/Constructor_2C17410C0FC3.md) | Initializes a new instance of the BotEvents.Player.PlayerDiedDelegate delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(AsyncCallback, object)](PlayerDiedDelegate/Methods/BeginInvoke_38AF922CA72E.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](PlayerDiedDelegate/Methods/EndInvoke_7F32A2B898A9.md) | Completes asynchronous invocation of the delegate. |
