...
Represents a delegate for level up.
...
## Syntax
```csharp
public sealed delegate BotEvents.Player.LevelUpDelegate
```

The BotEvents.Player.LevelUpDelegate type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [LevelUpDelegate(object, nint)](LevelUpDelegate/Constructors/Constructor_D241AAEEE5C2.md) | Initializes a new instance of the BotEvents.Player.LevelUpDelegate delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(LevelUpEventArgs, AsyncCallback, object)](LevelUpDelegate/Methods/BeginInvoke_7BED4F9ADB5C.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](LevelUpDelegate/Methods/EndInvoke_FD8A6024A86F.md) | Completes asynchronous invocation of the delegate. |
