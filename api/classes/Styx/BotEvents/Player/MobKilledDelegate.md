...
Represents a delegate for mob killed.
...
## Syntax
```csharp
public sealed delegate BotEvents.Player.MobKilledDelegate
```

The BotEvents.Player.MobKilledDelegate type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [MobKilledDelegate(object, nint)](MobKilledDelegate/Constructors/Constructor_07A169668558.md) | Initializes a new instance of the BotEvents.Player.MobKilledDelegate delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(MobKilledEventArgs, AsyncCallback, object)](MobKilledDelegate/Methods/BeginInvoke_212C457A6772.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](MobKilledDelegate/Methods/EndInvoke_E96B20649BE2.md) | Completes asynchronous invocation of the delegate. |
