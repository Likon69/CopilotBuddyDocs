...
Represents a delegate for mob looted.
...
## Syntax
```csharp
public sealed delegate BotEvents.Player.MobLootedDelegate
```

The BotEvents.Player.MobLootedDelegate type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [MobLootedDelegate(object, nint)](MobLootedDelegate/Constructors/Constructor_0F1136A00CB0.md) | Initializes a new instance of the BotEvents.Player.MobLootedDelegate delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(MobLootedEventArgs, AsyncCallback, object)](MobLootedDelegate/Methods/BeginInvoke_B1101E142680.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](MobLootedDelegate/Methods/EndInvoke_7123B1FA3A8A.md) | Completes asynchronous invocation of the delegate. |
