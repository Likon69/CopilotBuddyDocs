...
Represents values for WoW Gender.
...
## Syntax
```csharp
public sealed enum WoWGender
```

The WoWGender type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [WoWGender](WoWGender/Constructors/Constructor_7B2CA2E744ED.md) | Initializes a new instance of the WoWGender enumeration. |

## Fields

| | Name | Description |
| --- | --- | --- |
| Public field | [Female](WoWGender/Fields/Female_87C879AFAB08.md) | Represents the female value. |
| Public field | [Male](WoWGender/Fields/Male_9B3FC0C993DD.md) | Represents the male value. |
| Public field | [Unknown](WoWGender/Fields/Unknown_9D74B8E9DC3E.md) | Represents the unknown value. |
