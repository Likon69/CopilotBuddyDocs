...
Represents values for WoW State Flag.
...
## Syntax
```csharp
public sealed enum WoWStateFlag
```

The WoWStateFlag type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [WoWStateFlag](WoWStateFlag/Constructors/Constructor_5128B61A2A9E.md) | Initializes a new instance of the WoWStateFlag enumeration. |

## Fields

| | Name | Description |
| --- | --- | --- |
| Public field | [AlwaysStand](WoWStateFlag/Fields/AlwaysStand_1011C198503E.md) | Represents the always stand value. |
| Public field | [None](WoWStateFlag/Fields/None_367B7AAB0FD9.md) | Represents the none value. |
| Public field | [Sneaking](WoWStateFlag/Fields/Sneaking_065284A208AF.md) | Represents the sneaking value. |
| Public field | [UnTrackable](WoWStateFlag/Fields/UnTrackable_273337C6E915.md) | Represents the un trackable value. |
