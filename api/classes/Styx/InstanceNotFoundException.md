...
Exception thrown when an LFG dungeon instance cannot be found for a given mapId. HB 4.3.4: thrown by GetLfgDungeonIdFromMapId when no matching entry exists in LfgDungeons.dbc.

## Inheritance Hierarchy
System.Object
  System.Exception
    Styx.InstanceNotFoundException
...
The InstanceNotFoundException type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [InstanceNotFoundException](InstanceNotFoundException/Constructors/Constructor_13B55C956BD3.md) | Initializes a new instance of the InstanceNotFoundException class. |
| Public constructor | [InstanceNotFoundException(string)](InstanceNotFoundException/Constructors/Constructor_FDF368C023AA.md) | Initializes a new instance of the InstanceNotFoundException class. |
| Public constructor | [InstanceNotFoundException(string, Exception)](InstanceNotFoundException/Constructors/Constructor_F96344F98472.md) | Initializes a new instance of the InstanceNotFoundException class. |
