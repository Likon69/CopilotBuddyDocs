...
Represents values for WoW Game Object State.
...
## Syntax
```csharp
public sealed enum WoWGameObjectState
```

The WoWGameObjectState type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [WoWGameObjectState](WoWGameObjectState/Constructors/Constructor_EF548562C4C7.md) | Initializes a new instance of the WoWGameObjectState enumeration. |

## Fields

| | Name | Description |
| --- | --- | --- |
| Public field | [Active](WoWGameObjectState/Fields/Active_1723142C214E.md) | Represents the active value. |
| Public field | [ActiveAlternative](WoWGameObjectState/Fields/ActiveAlternative_5E20655B0506.md) | Represents the active alternative value. |
| Public field | [Destroyed](WoWGameObjectState/Fields/Destroyed_166289FE9542.md) | Represents the destroyed value. |
| Public field | [Ready](WoWGameObjectState/Fields/Ready_344258DFE1C6.md) | Represents the ready value. |
