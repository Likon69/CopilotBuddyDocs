# WoWMovementInfo.MovementFlag Enumeration

Movement flags for WoW 3.3.5a. Ported from HB 4.3.4.
...
## Syntax
```csharp
public sealed enum WoWMovementInfo.MovementFlag
```

The WoWMovementInfo.MovementFlag type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [MovementFlag](MovementFlag/Constructors/Constructor_3CE0F1469E21.md) | Initializes a new instance of the WoWMovementInfo.MovementFlag enumeration. |

## Fields

| | Name | Description |
| --- | --- | --- |
| Public field | [Ascending](MovementFlag/Fields/Ascending_44AB09334DAF.md) | Represents the ascending value. |
...
| Public field | [FallingSlow](MovementFlag/Fields/FallingSlow_D976A35A850D.md) | Represents the falling slow value. |
...
| Public field | [PendingSTrFlagLeft](MovementFlag/Fields/PendingSTrFlagLeft_B7F9A4AB0BC2.md) | Represents the pending s tr flag left value. |
...
| Public field | [StrafeMask](MovementFlag/Fields/StrafeMask_7FF3B8AA1C3B.md) | Represents the strafe mask value. |
| Public field | [StrafeRight](MovementFlag/Fields/StrafeRight_D53CB0B4586B.md) | Represents the strafe right value. |
| Public field | [Swimming](MovementFlag/Fields/Swimming_4A519CFE2DDB.md) | Represents the swimming value. |
