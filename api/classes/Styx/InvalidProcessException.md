...
Thrown when the selected WoW process cannot be attached to. Ported from HB 4.3.4 InvalidProcessException.

## Inheritance Hierarchy
System.Object
  System.Exception
    Styx.InvalidProcessException
...
The InvalidProcessException type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [InvalidProcessException](InvalidProcessException/Constructors/Constructor_1ACF98F71FEE.md) | Initializes a new instance of the InvalidProcessException class. |
| Public constructor | [InvalidProcessException(string)](InvalidProcessException/Constructors/Constructor_28EEF3D4E288.md) | Initializes a new instance of the InvalidProcessException class. |
| Public constructor | [InvalidProcessException(string, Exception)](InvalidProcessException/Constructors/Constructor_673A53FE1905.md) | Initializes a new instance of the InvalidProcessException class. |
