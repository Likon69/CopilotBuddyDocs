# NavigatorLogMessage Delegate

Represents a delegate for Navigator Log Message.
...
## Syntax
```csharp
public sealed delegate NavigatorLogMessage
```

The NavigatorLogMessage type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [NavigatorLogMessage(object, nint)](NavigatorLogMessage/Constructors/Constructor_DE7109AC338E.md) | Initializes a new instance of the NavigatorLogMessage delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(string, AsyncCallback, object)](NavigatorLogMessage/Methods/BeginInvoke_13F10CA8C0F8.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](NavigatorLogMessage/Methods/EndInvoke_620E798256D9.md) | Completes asynchronous invocation of the delegate. |
