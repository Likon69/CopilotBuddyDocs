...
| Public property | [Extents](Navigator/Properties/Extents_7B0CCA9E9E09.md) | Search extents for navmesh queries (X, Y, Z). Default: 3, 20, 3 yards. |
...
| Public method | [SetPathRandomization(bool, float)](Navigator/Methods/SetPathRandomization_D033FBBDBD98.md) | Sets path randomization for more natural movement. |
