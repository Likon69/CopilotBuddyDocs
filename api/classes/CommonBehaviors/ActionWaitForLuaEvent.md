...
Represents an action that waits for a Lua event.

## Inheritance Hierarchy
System.Object
  TreeSharp.Composite
    TreeSharp.Action
      CommonBehaviors.ActionWaitForLuaEvent
...
The ActionWaitForLuaEvent type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionWaitForLuaEvent(string, int)](ActionWaitForLuaEvent/Constructors/Constructor_C86EDB84F432.md) | Initializes a new instance of the ActionWaitForLuaEvent class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](ActionWaitForLuaEvent/Methods/Run_6EC34F1F1F8B.md) | Runs the action. (Overrides Action.Run().) |
| Public method | [Start(object)](ActionWaitForLuaEvent/Methods/Start_8B87EB2E3A8B.md) | Starts the bot. (Overrides Composite.Start().) |
| Public method | [Stop(object)](ActionWaitForLuaEvent/Methods/Stop_69BEA236BCA0.md) | Stops the bot. (Overrides Composite.Stop().) |
