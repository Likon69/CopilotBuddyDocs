...
Represents an is point of interest type decorator.
...
The DecoratorIsPoiType type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [DecoratorIsPoiType(PoiType, Composite)](DecoratorIsPoiType/Constructors/Constructor_BFD47D7AE3BD.md) | Initializes a new instance of the DecoratorIsPoiType class. |
| Public constructor | [DecoratorIsPoiType(IEnumerable<PoiType>, Composite)](DecoratorIsPoiType/Constructors/Constructor_43116B7C4CE1.md) | Initializes a new instance of the DecoratorIsPoiType class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [CanRun(object)](DecoratorIsPoiType/Methods/CanRun_2816F9626AE2.md) | Determines whether can run. (Overrides Decorator.CanRun().) |
