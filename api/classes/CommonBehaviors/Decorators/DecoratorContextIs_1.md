...
Represents a context is decorator.
...
System.Object
  TreeSharp.Composite
    TreeSharp.GroupComposite
      TreeSharp.Decorator
        CommonBehaviors.Decorators.DecoratorContextIs<T>
...
The DecoratorContextIs<T> type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [DecoratorContextIs(Composite)](DecoratorContextIs_1/Constructors/Constructor_CF0906EBF127.md) | Initializes a new instance of the DecoratorContextIs<T> class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [CanRun(object)](DecoratorContextIs_1/Methods/CanRun_F738477774CA.md) | Determines whether can run. (Overrides Decorator.CanRun().) |
