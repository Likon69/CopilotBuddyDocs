...
Represents a frame is visible decorator.
...
System.Object
  TreeSharp.Composite
    TreeSharp.GroupComposite
      TreeSharp.Decorator
        CommonBehaviors.Decorators.DecoratorFrameIsVisible<T>
...
The DecoratorFrameIsVisible<T> type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [DecoratorFrameIsVisible(Composite)](DecoratorFrameIsVisible_1/Constructors/Constructor_0D551E26521B.md) | Initializes a new instance of the DecoratorFrameIsVisible<T> class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [CanRun(object)](DecoratorFrameIsVisible_1/Methods/CanRun_7EB453599FBD.md) | Determines whether can run. (Overrides Decorator.CanRun().) |
