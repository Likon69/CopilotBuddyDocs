...
Represents an action that always fails.

## Inheritance Hierarchy
System.Object
  TreeSharp.Composite
    TreeSharp.Action
      CommonBehaviors.Actions.ActionAlwaysFail
...
The ActionAlwaysFail type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionAlwaysFail](ActionAlwaysFail/Constructors/Constructor_1035EB2F0218.md) | Initializes a new instance of the ActionAlwaysFail class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](ActionAlwaysFail/Methods/Run_CAD25608DE03.md) | Runs the action. (Overrides Action.Run().) |
