...
System.Object
  TreeSharp.Composite
    TreeSharp.Action
      CommonBehaviors.Actions.ActionSleep
...
The ActionSleep type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionSleep(int)](ActionSleep/Constructors/Constructor_E26602398FB8.md) | Initializes a new instance of the ActionSleep class. |

## Fields

| | Name | Description |
| --- | --- | --- |
| Public field | [SleepTime](ActionSleep/Fields/SleepTime_77081A5633C6.md) | Stores the sleep time. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](ActionSleep/Methods/Run_6A7EC667C654.md) | Runs the action. (Overrides Action.Run().) |
