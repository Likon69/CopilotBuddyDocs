# ActionInteract Class

Represents an interact action.

## Inheritance Hierarchy
System.Object
  TreeSharp.Composite
    TreeSharp.Action
      CommonBehaviors.Actions.ActionInteract
...
The ActionInteract type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionInteract](ActionInteract/Constructors/Constructor_95B920AAED00.md) | Initializes a new instance of the ActionInteract class. |
| Public constructor | [ActionInteract(bool)](ActionInteract/Constructors/Constructor_C72DCAA5F95E.md) | Initializes a new instance of the ActionInteract class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](ActionInteract/Methods/Run_0CB058940B8B.md) | Runs the action. (Overrides Action.Run().) |
