  ...
  TreeSharp.Composite
    TreeSharp.Action
      CommonBehaviors.Actions.ActionAlwaysSucceed
        CommonBehaviors.Actions.ActionIdle
...
The ActionIdle type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionIdle](ActionIdle/Constructors/Constructor_9FB637EDFF92.md) | Initializes a new instance of the ActionIdle class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](ActionIdle/Methods/Run_046F84456A82.md) | Runs the action. (Overrides ActionAlwaysSucceed.Run().) |
