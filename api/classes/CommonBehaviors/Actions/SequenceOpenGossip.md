# SequenceOpenGossip Class

Represents an open gossip sequence.

## Inheritance Hierarchy
System.Object
  TreeSharp.Composite
    TreeSharp.Action
      CommonBehaviors.Actions.SequenceOpenGossip
...
## Syntax
```csharp
public class SequenceOpenGossip : Action
```

The SequenceOpenGossip type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [SequenceOpenGossip](SequenceOpenGossip/Constructors/Constructor_761F0DDB6182.md) | Initializes a new instance of the SequenceOpenGossip class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](SequenceOpenGossip/Methods/Run_966E1A1B6DD7.md) | Runs the action. (Overrides Action.Run().) |
