...
HB MoP/WoD style ActionMoveToPoi with anti-spam logging. Tracks last target GUID and location to avoid spamming logs.
  ...
  TreeSharp.Composite
    TreeSharp.Action
      CommonBehaviors.Actions.NavigationAction
        CommonBehaviors.Actions.ActionMoveToPoi
...
The ActionMoveToPoi type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionMoveToPoi](ActionMoveToPoi/Constructors/Constructor_24A043B7BC26.md) | Initializes a new instance of the ActionMoveToPoi class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](ActionMoveToPoi/Methods/Run_1F77C29A6C46.md) | Runs the action. (Overrides NavigationAction.Run().) |
