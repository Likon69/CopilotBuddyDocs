...
Represents a set activity action.

## Inheritance Hierarchy
System.Object
  TreeSharp.Composite
    TreeSharp.Action
      CommonBehaviors.Actions.ActionSetActivity
...
The ActionSetActivity type exposes the following members.

## Nested Types

| | Name | Description |
| --- | --- | --- |
| Public delegate | [ActionSetActivity.GetStatusTextDelegate](ActionSetActivity/GetStatusTextDelegate.md) | Represents a delegate for get status text. |

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionSetActivity(string)](ActionSetActivity/Constructors/Constructor_CE099FBAC5F9.md) | Initializes a new instance of the ActionSetActivity class. |
| Public constructor | [ActionSetActivity(GetStatusTextDelegate)](ActionSetActivity/Constructors/Constructor_71C403CD7585.md) | Initializes a new instance of the ActionSetActivity class. |
| Public constructor | [ActionSetActivity(string, object[])](ActionSetActivity/Constructors/Constructor_16F7772A3EB0.md) | Initializes a new instance of the ActionSetActivity class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](ActionSetActivity/Methods/Run_C1E75E2CF102.md) | Runs the action. (Overrides Action.Run().) |
