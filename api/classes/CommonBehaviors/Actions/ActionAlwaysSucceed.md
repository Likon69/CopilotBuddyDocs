...
Represents an action that always succeeds.

## Inheritance Hierarchy
System.Object
  TreeSharp.Composite
    TreeSharp.Action
      CommonBehaviors.Actions.ActionAlwaysSucceed
...
The ActionAlwaysSucceed type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionAlwaysSucceed](ActionAlwaysSucceed/Constructors/Constructor_11B8BB9DA6C3.md) | Initializes a new instance of the ActionAlwaysSucceed class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](ActionAlwaysSucceed/Methods/Run_E9E2FDA520A3.md) | Runs the action. (Overrides Action.Run().) |
