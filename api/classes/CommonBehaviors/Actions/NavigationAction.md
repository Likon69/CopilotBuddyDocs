...
The NavigationAction type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [NavigationAction](NavigationAction/Constructors/Constructor_9789D08C4C9F.md) | Initializes a new instance of the NavigationAction class. |
| Public constructor | [NavigationAction(WoWPoint)](NavigationAction/Constructors/Constructor_3650A5A4F8C6.md) | Initializes a new instance of the NavigationAction class. |
| Public constructor | [NavigationAction(GetPointDelegate)](NavigationAction/Constructors/Constructor_922A2401CD25.md) | Initializes a new instance of the NavigationAction class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](NavigationAction/Methods/Run_02E4C596A877.md) | Runs the action. (Overrides Action.Run().) |
