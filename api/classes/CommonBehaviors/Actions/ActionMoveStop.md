# ActionMoveStop Class

Represents a move stop action.

## Inheritance Hierarchy
System.Object
  TreeSharp.Composite
    TreeSharp.Action
      CommonBehaviors.Actions.ActionMoveStop
...
## Syntax
```csharp
public class ActionMoveStop : Action
```

The ActionMoveStop type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionMoveStop](ActionMoveStop/Constructors/Constructor_27C6C12C5CB6.md) | Initializes a new instance of the ActionMoveStop class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](ActionMoveStop/Methods/Run_99FA6A157C18.md) | Runs the action. (Overrides Action.Run().) |
