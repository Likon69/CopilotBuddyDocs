...
Represents a delegate for debug string.
...
## Syntax
```csharp
public sealed delegate DebugStringDelegate
```

The DebugStringDelegate type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [DebugStringDelegate(object, nint)](DebugStringDelegate/Constructors/Constructor_24CA6D27EDF5.md) | Initializes a new instance of the DebugStringDelegate delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(object, AsyncCallback, object)](DebugStringDelegate/Methods/BeginInvoke_BEDF6D0786BD.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](DebugStringDelegate/Methods/EndInvoke_1873BFF0F0B5.md) | Completes asynchronous invocation of the delegate. |
