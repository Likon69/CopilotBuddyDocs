...
Represents an action that writes a debug string.

## Inheritance Hierarchy
System.Object
  TreeSharp.Composite
    TreeSharp.Action
      CommonBehaviors.Actions.ActionDebugString
...
The ActionDebugString type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionDebugString(DebugStringDelegate)](ActionDebugString/Constructors/Constructor_47C6F08F61A5.md) | Initializes a new instance of the ActionDebugString class. |
| Public constructor | [ActionDebugString(string)](ActionDebugString/Constructors/Constructor_99EB45DBF9A0.md) | Initializes a new instance of the ActionDebugString class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](ActionDebugString/Methods/Run_6529CF831861.md) | Runs the action. (Overrides Action.Run().) |
