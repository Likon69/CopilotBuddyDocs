...
Represents a set point of interest action.

## Inheritance Hierarchy
System.Object
  TreeSharp.Composite
    TreeSharp.Action
      CommonBehaviors.Actions.ActionSetPoi
...
The ActionSetPoi type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionSetPoi(RetrieveBotPoiDelegate)](ActionSetPoi/Constructors/Constructor_F276B70E3263.md) | Initializes a new instance of the ActionSetPoi class. |
| Public constructor | [ActionSetPoi(bool, RetrieveBotPoiDelegate)](ActionSetPoi/Constructors/Constructor_A93EE1137721.md) | Initializes a new instance of the ActionSetPoi class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](ActionSetPoi/Methods/Run_C98C94E9924A.md) | Runs the action. (Overrides Action.Run().) |
