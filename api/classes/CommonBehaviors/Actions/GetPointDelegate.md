# GetPointDelegate Delegate

Represents a delegate for get point.
...
## Syntax
```csharp
public sealed delegate GetPointDelegate
```

The GetPointDelegate type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [GetPointDelegate(object, nint)](GetPointDelegate/Constructors/Constructor_AF9D961B9ADA.md) | Initializes a new instance of the GetPointDelegate delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(object, AsyncCallback, object)](GetPointDelegate/Methods/BeginInvoke_04019D03DF00.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](GetPointDelegate/Methods/EndInvoke_FBB37C541DFC.md) | Completes asynchronous invocation of the delegate. |
