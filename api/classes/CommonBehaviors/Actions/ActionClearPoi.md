...
Represents an action that clears the current point of interest.

## Inheritance Hierarchy
System.Object
  TreeSharp.Composite
    TreeSharp.Action
      CommonBehaviors.Actions.ActionClearPoi
...
The ActionClearPoi type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionClearPoi](ActionClearPoi/Constructors/Constructor_C5A85F01B493.md) | Initializes a new instance of the ActionClearPoi class. |
| Public constructor | [ActionClearPoi(string)](ActionClearPoi/Constructors/Constructor_4FF8CDF5CBB6.md) | Initializes a new instance of the ActionClearPoi class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](ActionClearPoi/Methods/Run_6D5FCE22B52F.md) | Runs the action. (Overrides Action.Run().) |
