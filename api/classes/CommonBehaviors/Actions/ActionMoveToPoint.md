...
Represents a move to point action.
  ...
  TreeSharp.Composite
    TreeSharp.Action
      CommonBehaviors.Actions.NavigationAction
        CommonBehaviors.Actions.ActionMoveToPoint
...
The ActionMoveToPoint type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionMoveToPoint(WoWPoint)](ActionMoveToPoint/Constructors/Constructor_676D5BA5A080.md) | Initializes a new instance of the ActionMoveToPoint class. |

## Fields

| | Name | Description |
| --- | --- | --- |
| Public field | [Point](ActionMoveToPoint/Fields/Point_1A65D81FCFBC.md) | Stores the point. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Run(object)](ActionMoveToPoint/Methods/Run_1AAA4AD18C36.md) | Runs the action. (Overrides NavigationAction.Run().) |
