...
Represents a point-of-interest sequence.
...
The PoiSequence type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [PoiSequence(Composite[])](PoiSequence/Constructors/Constructor_2D15D436F792.md) | Initializes a new instance of the PoiSequence class. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [Tick(object)](PoiSequence/Methods/Tick_FC01C95746E6.md) | Processes one tick. (Overrides Composite.Tick().) |
| Protected method | Execute(object) | Executes the composite. (Overrides Composite.Execute().). (Inherited from Sequence.) |
