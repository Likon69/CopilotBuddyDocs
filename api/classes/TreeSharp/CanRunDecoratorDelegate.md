...
Represents a delegate for can run decorator.
...
## Syntax
```csharp
public sealed delegate CanRunDecoratorDelegate
```

The CanRunDecoratorDelegate type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [CanRunDecoratorDelegate(object, nint)](CanRunDecoratorDelegate/Constructors/Constructor_6357530C2F6D.md) | Initializes a new instance of the CanRunDecoratorDelegate delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(object, AsyncCallback, object)](CanRunDecoratorDelegate/Methods/BeginInvoke_99D1F1D39A79.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](CanRunDecoratorDelegate/Methods/EndInvoke_F7F02644945F.md) | Completes asynchronous invocation of the delegate. |
