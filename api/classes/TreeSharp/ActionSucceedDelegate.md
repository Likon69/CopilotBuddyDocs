...
Represents a delegate for action succeed.
...
## Syntax
```csharp
public sealed delegate ActionSucceedDelegate
```

The ActionSucceedDelegate type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionSucceedDelegate(object, nint)](ActionSucceedDelegate/Constructors/Constructor_6DE9047FAA8B.md) | Initializes a new instance of the ActionSucceedDelegate delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(object, AsyncCallback, object)](ActionSucceedDelegate/Methods/BeginInvoke_A48C5005850D.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](ActionSucceedDelegate/Methods/EndInvoke_659321E58582.md) | Completes asynchronous invocation of the delegate. |
