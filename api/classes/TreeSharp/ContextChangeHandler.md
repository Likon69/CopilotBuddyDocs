...
Represents a delegate for Context Change Handler.
...
## Syntax
```csharp
public sealed delegate ContextChangeHandler
```

The ContextChangeHandler type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ContextChangeHandler(object, nint)](ContextChangeHandler/Constructors/Constructor_23E57FD8F468.md) | Initializes a new instance of the ContextChangeHandler delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(object, AsyncCallback, object)](ContextChangeHandler/Methods/BeginInvoke_A39C5FDE1807.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](ContextChangeHandler/Methods/EndInvoke_6A81C894E26A.md) | Completes asynchronous invocation of the delegate. |
