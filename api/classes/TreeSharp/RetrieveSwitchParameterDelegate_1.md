...
Represents a delegate for retrieve switch parameter.
...
## Syntax
```csharp
public sealed delegate RetrieveSwitchParameterDelegate<T>
```

The RetrieveSwitchParameterDelegate<T> type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [RetrieveSwitchParameterDelegate(object, nint)](RetrieveSwitchParameterDelegate_1/Constructors/Constructor_FC59D013B171.md) | Initializes a new instance of the RetrieveSwitchParameterDelegate<T> delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(object, AsyncCallback, object)](RetrieveSwitchParameterDelegate_1/Methods/BeginInvoke_386E254C8B46.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](RetrieveSwitchParameterDelegate_1/Methods/EndInvoke_76DE6B5EE585.md) | Completes asynchronous invocation of the delegate. |
