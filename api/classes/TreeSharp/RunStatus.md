...
| | Name | Description |
| --- | --- | --- |
| Public constructor | [RunStatus](RunStatus/Constructors/Constructor_DCFCD1AE529B.md) | Initializes a new instance of the RunStatus enumeration. |

## Fields

| | Name | Description |
| --- | --- | --- |
| Public field | [Failure](RunStatus/Fields/Failure_1DCA55E919D9.md) | Represents the failure value. |
| Public field | [Running](RunStatus/Fields/Running_09225A73FC14.md) | Represents the running value. |
| Public field | [Success](RunStatus/Fields/Success_4C52E37C1926.md) | Represents the success value. |
