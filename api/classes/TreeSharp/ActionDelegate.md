...
Represents a delegate for action.
...
## Syntax
```csharp
public sealed delegate ActionDelegate
```

The ActionDelegate type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [ActionDelegate(object, nint)](ActionDelegate/Constructors/Constructor_5EDF80BD25D7.md) | Initializes a new instance of the ActionDelegate delegate. |
...
| | Name | Description |
| --- | --- | --- |
| Public method | [BeginInvoke(object, AsyncCallback, object)](ActionDelegate/Methods/BeginInvoke_51FAC0F81342.md) | Begins asynchronous invocation of the delegate. |
| Public method | [EndInvoke(IAsyncResult)](ActionDelegate/Methods/EndInvoke_E29A94038EA5.md) | Completes asynchronous invocation of the delegate. |
