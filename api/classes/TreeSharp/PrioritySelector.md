...
The PrioritySelector type exposes the following members.

## Constructors

| | Name | Description |
| --- | --- | --- |
| Public constructor | [PrioritySelector(Composite[])](PrioritySelector/Constructors/Constructor_D2CE1759AAFD.md) | Initializes a new instance of the PrioritySelector class. |
| Public constructor | [PrioritySelector(ContextChangeHandler, Composite[])](PrioritySelector/Constructors/Constructor_D723B9470DB3.md) | Initializes a new instance of the PrioritySelector class. |
...
| | Name | Description |
| --- | --- | --- |
| Protected method | [Execute(object)](PrioritySelector/Methods/Execute_DE93091B8439.md) | Executes the composite. (Overrides Selector.Execute().) |
